...
<head>
    <meta charset="utf-8">
    <title>Sertifikat Penulis</title>
    <style>
    ...
    <div class="certificate">
        <div class="border-outer">
            <div class="border-inner">
                ...
                <div class="recipient">{{ $author->name_with_title ?? $author->name }}</div>
                @if($author->affiliation)
                    <p style="font-size: 13px; color: #888; margin-top: 5px;">{{ $author->affiliation }}</p>
                @endif
                <div class="description">
                    Sebagai penulis dalam penerbitan buku berjudul:
                    <br>
