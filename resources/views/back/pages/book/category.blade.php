    ...
    <div class="modal fade" tabindex="-1" id="add_category">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('back.book.category.store') }}" method="POST">
                    @csrf
        ...
        <div class="modal fade" tabindex="-1" id="edit_category{{ $category->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('back.book.category.update', $category->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
        ...
        <div class="modal fade" tabindex="-1" id="delete_category{{ $category->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('back.book.category.destroy', $category->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
