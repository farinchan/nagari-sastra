                        ...
                        <div class="col-lg-4">
                            <div class="sticky-top" style="top: 80px; z-index: 1;">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="mb-3">
                                        @if ($book->thumbnail)
                                            <img src="{{ Storage::url($book->thumbnail) }}" alt="Thumbnail" class="img-fluid rounded" />
                                        @else
                                ...
                                <div class="mb-6">
                                    ...
                                    @if ($book->preview_file)
                                        <div class="mb-2">
                                            <a href="{{ $book->getPreviewFile() }}" target="_blank" class="btn btn-sm btn-light w-100">
                                                <i class="ki-duotone ki-file-pdf"></i> Download
                                            </a>
                                        </div>
                                    @endif
                                ...
                                <div class="mb-6">
                                    ...
                                    @if ($book->attachment)
                                        <div class="mb-2">
                                            <a href="{{ $book->getAttachment() }}" target="_blank" class="btn btn-sm btn-light w-100">
                                                <i class="ki-duotone ki-file-pdf"></i> Download
                                            </a>
                                        </div>
                                    @endif
                            ...
                            <div class="row mb-6">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="authorString" class="form-control @error('authorString') is-invalid @enderror"
                                        placeholder="Semua penulis beserta gelar" value="{{ old('authorString', $book->authorString) }}" />
                                    @error('authorString')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-6">
                                <div class="col-12">
                                    ...
                                    <input id="authors_tagify" name="authors" class="form-control @error('authors') is-invalid @enderror"
                                        value="{{ old('authors', $book->authors ? json_encode($book->authors) : '') }}" placeholder="Nama penulis tanpa gelar, tekan Enter" />
                                    @error('authors')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row mb-6">
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                        placeholder="Deskripsi Buku" rows="4">{{ old('description', $book->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
