...
@section('content')
    <div id="kt_content_container" class=" container-xxl ">
        <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
            action="{{ route('back.product.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5">
                            ...
                            <small class="text-muted">Format: .zip, .rar, .gz, .tar (Max: 50MB)</small>
                        </div>
                        @error('file')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror"
                                value="{{ old('price') }}" min="0" step="1" placeholder="0" />
                            @error('price')
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" name="discount_price" class="form-control @error('discount_price') is-invalid @enderror"
                                value="{{ old('discount_price') }}" min="0" step="1" placeholder="0" />
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <textarea name="short_description" class="form-control mb-2 @error('short_description') is-invalid @enderror"
                                rows="3" placeholder="Deskripsi singkat produk">{{ old('short_description') }}</textarea>
                        ...
                        <div class="row mb-10">
                            <div class="col-lg-6 fv-row mb-5">
                                ...
                                <input type="text" name="version" class="form-control @error('version') is-invalid @enderror"
                                    value="{{ old('version') }}" placeholder="cth: 1.0.0" />
                                @error('version')
                                    <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-lg-6 fv-row mb-5">
                                ...
                                <input type="text" name="compatibility" class="form-control @error('compatibility') is-invalid @enderror"
                                    value="{{ old('compatibility') }}" placeholder="cth: Laravel 10, PHP 8.1+" />
                                @error('compatibility')
                                    <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-lg-6 fv-row mb-5">
                                ...
                                <input type="url" name="documentation_url" class="form-control @error('documentation_url') is-invalid @enderror"
                                    value="{{ old('documentation_url') }}" placeholder="https://docs.example.com" />
