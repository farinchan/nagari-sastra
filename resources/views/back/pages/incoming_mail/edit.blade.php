...
<div id="kt_content_container" class=" container-xxl ">
    <form class="form d-flex flex-column flex-lg-row" action="{{ route('back.incoming-mail.update', $mail->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="row mb-7">
                        <div class="col-md-6">
                            <div class="fv-row">
                                ...
                                <input type="text" name="nomor_surat" class="form-control mb-2" placeholder="Masukkan nomor surat" value="{{ old('nomor_surat', $mail->nomor_surat) }}" required />
                                @error('nomor_surat')
                        ...
                        <div class="col-md-6">
                            <div class="fv-row">
                                ...
                                <input type="text" name="pengirim" class="form-control mb-2" placeholder="Masukkan nama pengirim" value="{{ old('pengirim', $mail->pengirim) }}" required />
                                @error('pengirim')
                                    <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-md-4">
                            <div class="fv-row">
                                ...
                                <input type="date" name="tanggal_diterima" class="form-control mb-2" value="{{ old('tanggal_diterima', $mail->tanggal_diterima) }}" required />
