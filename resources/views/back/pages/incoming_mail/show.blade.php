    ...
    <div class="card card-flush py-4">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('back.incoming-mail.edit', $mail->id) }}" class="btn btn-sm btn-primary me-2">
                    <i class="ki-duotone ki-pencil fs-4"></i> Edit
                </a>
                <a href="{{ route('back.incoming-mail.index') }}" class="btn btn-sm btn-light">
        ...
        <div class="card-body pt-0">
            ...
            <div class="row mb-7">
                <label class="col-lg-3 fw-semibold text-muted">Pengirim</label>
                <div class="col-lg-9">
                    <span class="fw-bold fs-6 text-gray-800">{{ $mail->pengirim }}</span>
                </div>
            </div>
            <div class="row mb-7">
            ...
            <div class="row mb-7">
                <label class="col-lg-3 fw-semibold text-muted">Tanggal Diterima</label>
                <div class="col-lg-9">
                    <span class="fw-bold fs-6 text-gray-800">{{ \Carbon\Carbon::parse($mail->tanggal_diterima)->format('d F Y') }}</span>
                </div>
            </div>
            <div class="row mb-7">
            ...
            <div class="row mb-7">
                <label class="col-lg-3 fw-semibold text-muted">Dicatat Oleh</label>
                <div class="col-lg-9">
