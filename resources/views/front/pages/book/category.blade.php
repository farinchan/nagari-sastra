...
@section('seo')
    ...
    <meta property="og:url" content="{{ route('book.category', $category->slug) }}">
    <link rel="canonical" href="{{ route('book.category', $category->slug) }}">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <h3 class="h3-lg mb-2">{{ $category->name }}</h3>
                    @if ($category->description)
                        <p class="p-md grey-color">{{ $category->description }}</p>
                    @endif
                </div>
                ...
                <aside id="sidebar" class="col-lg-3">
                    ...
                    <div id="search-field" class="sidebar-div ico-20 mb-50">
                        <div class="input-group mb-3">
                            <form action="{{ route('book.index') }}" method="GET" class="d-flex w-100">
                                <input type="text" class="form-control" placeholder="Cari Buku..." aria-label="Search"
                                    name="q" aria-describedby="search-field">
                    ...
                    <div class="blog-categories sidebar-div mb-50">
                        ...
                        <ul class="blog-category-list clearfix">
                            ...
                            @foreach ($categories as $cat)
                                <li>
                                    <p><a href="{{ route('book.category', $cat->slug) }}"
                                        @if ($cat->id === $category->id) class="theme-color" @endif>
                                        {{ $cat->name }}
                                    </a>
